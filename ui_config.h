 ...
 * @brief Configuration of user interface.
 */
...
/** @brief Specify the width of the display. */
#define UI_DISPLAY_WIDTH                    240u
/** @brief Specify the height of the display. */
#define UI_DISPLAY_HEIGHT                   536u
